...
```swift
let client = ConfigCatClient(apiKey: "<PLACE-YOUR-SDK-KEY-HERE>")
```
...
```swift
let client = ConfigCatClient(apiKey: "#YOUR-SDK-KEY#")
...
let client = ConfigCatClient(
    apiKey: "<PLACE-YOUR-SDK-KEY-HERE>", 
...
```swift
let client = ConfigCatClient(apiKey: "<PLACE-YOUR-SDK-KEY-HERE>", configCache: MyCustomCache())
```
