...
| `dataGovernance(DataGovernance)`                                                      | Optional, defaults to `Global`. Describes the location of your feature flag and setting data within the ConfigCat CDN. Set this parameter to be in sync with your [Data Governance](docs/advanced/data-governance.md) preference. Available options: `Global`, `EuOnly`.                                                                            |
