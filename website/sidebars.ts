...
const sidebars: SidebarsConfig = {
  docs: docs.map(item => assignKeyToItems(item)),
  sdks: sdks.map(item => assignKeyToItems(item)),
  integrations: integrations.map(item => assignKeyToItems(item)),
};
