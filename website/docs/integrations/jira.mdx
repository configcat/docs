...
Turn features On / Off right from a linked Issue on your Jira board. Modify or add new Targeting or Percentage Rules easily to the linked flags.
...
2. Open `ConfigCat Feature Flag` issue context.
