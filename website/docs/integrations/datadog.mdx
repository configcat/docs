...
2. Get a <a href="https://docs.datadoghq.com/account_management/api-app-keys/#api-keys" target="_blank">Datadog API Key.</a>
   <img
     src="/docs/assets/datadog_apikey2.png"
     className="zoomable"
     alt="datadog_event"
   />
...
<img
  src="/docs/assets/datadog_filtering.png"
  className="zoomable"
  alt="datadog_filtering"
/>
