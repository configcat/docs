...
### Compatible IDEs
The plugin is compatible with the following IDEs. Check the plugin [JetBrains Marketplace](https://github.com/configcat/intellij-plugin/releases/latest) page for the full, detailed compatibility list.
