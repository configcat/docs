...
3. Subscribe to the `flagEvaluated` hook during the ConfigCat SDK initialization and send feature flag evaluation data to Mixpanel experiments.
<Tabs>
...
:::
4. Check your Experiments in Mixpanel.  
