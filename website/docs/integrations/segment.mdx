...
<img src="/docs/assets/segment/featureflagchanged.png" className="bordered-img zoomable" alt="Twilio Segment Feature Flag Changed event" decoding="async" loading="lazy"/>
...
<img src="/docs/assets/segment/featureflagevaluated.png" className="bordered-img zoomable" alt="Twilio Segment event debugger" decoding="async" loading="lazy"/>
