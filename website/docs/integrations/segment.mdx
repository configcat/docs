...
<Steps>
<Step>
Have a <a href="https://segment.com/" target="_blank" rel="noopener noreferrer">Twilio Segment account.</a>
</Step>
<Step>
Add the <a href="https://segment.com/catalog/integrations/source/configcat/" target="_blank" rel="noopener noreferrer">ConfigCat source</a> to your Twilio Segment account and copy the Write Key.
</Step>
<Step>
Open the <a href="https://app.configcat.com/product/integrations" target="_blank" rel="noopener noreferrer">integrations tab</a> on the ConfigCat Dashboard.
</Step>
<Step>
Click on Twilio Segment's CONNECT button and set the Twilio Segment Write Key acquired while adding the ConfigCat source in Twilio Segment.
</Step>
<Step>
OPTIONAL - Set the proper server of your Twilio Segment account. <a href="https://segment.com/docs/guides/regional-segment/" target="_blank" rel="noopener noreferrer">More about Segment servers</a>.
</Step>
<Step>
You're all set. Go ahead and make some changes to your feature flags, then check your events in Twilio Segment.
</Step>
</Steps>
...
<Step>
Click on Twilio Segment's DISCONNECT button.
</Step>
</Steps>
...
<Steps>
<Step>
**Add ConfigCat source in Twilio Segment:** Add the ConfigCat source in Twilio Segment.
</Step>
<Step>
**Install SDKs:** Add both the ConfigCat SDK and Segment SDK to your application.
</Step>
<Step>
**Configure SDKs:**
...
<Step>
**Send an event to Twilio Segment** using the `Feature Flag Evaluated` event name. If the feature flag was evaluated with a user object, set the event's `userId` property to the user object's identifier. Otherwise, set the `anonymousId` property to a random generated string. Also, include the following event properties:
...
<Step>
Deploy your application and wait for feature flag evaluations to happen so feature flag evaluation events can be sent to Twilio Segment.
</Step>
<Step>
Add the preferred destination in Twilio Segment for your source and configure your mappings. 
</Step>
<Step>
Enable the destination and utilize advanced feature flag analytics in the destination.
</Step>
</Steps>
