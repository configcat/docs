...
- In order to let the CLI access to the ConfigCat Public Management API, you have to create a new <a target="_blank" href="https://app.configcat.com/my-account/public-api-credentials">API credential</a>.
