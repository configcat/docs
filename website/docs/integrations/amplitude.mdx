...
<img src="/docs/assets/integrations/amplitude/overview.png" alt="ConfigCat Amplitude Integration Overview" decoding="async" loading="lazy"/>
...
2. Get an <a href="https://www.docs.developers.amplitude.com/analytics/find-api-credentials/" target="_blank">Amplitude API Key and Secret Key.</a>
   <img src="/docs/assets/integrations/amplitude/setup.png" alt="ConfigCat Amplitude Integration Setup" decoding="async" loading="lazy"/>
...
<img src="/docs/assets/integrations/amplitude/annotation.png" className="bordered-img zoomable" alt="amplitude_annoation" decoding="async" loading="lazy"/>
...
<img src="/docs/assets/integrations/amplitude/customchart.png" className="bordered-img zoomable" alt="Amplitude custom chart" decoding="async" loading="lazy"/>
...
<img src="/docs/assets/integrations/amplitude/enriched.png" className="bordered-img zoomable" alt="Amplitude chart with enriched data" decoding="async" loading="lazy"/>