...
## Add feature flag changes to your charts
...
<img
  src="/docs/assets/amplitude_chart.png"
  className="zoomable"
  alt="amplitude_chart"
/>
...
2. Get an <a href="https://www.docs.developers.amplitude.com/analytics/find-api-credentials/" target="_blank">Amplitude API Key and Secret Key.</a>
   <img
     src="/docs/assets/amplitude_apikey_secretkey.png"
     className="zoomable"
     alt="amplitude_apikey_secretkey"
   />
...
<img
  src="/docs/assets/amplitude_annotation.png"
  className="zoomable"
  alt="amplitude_annoation"
/>
...
identify_obj.set(f'configcat*{evaluationDetails.key}', evaluation_details.value)
