...
5. Get your ConfigCat Public API credentials from <a href="https://app.configcat.com/my-account/public-api-credentials" target="_blank">ConfigCat Public Management API</a>.
...
1. Select the Product for which you want to receive notifications about Feature Flag or Setting changes.
1. For more specific notifications, select a Config and/or Environment.
