...
There are three ways to manage your Zombie flags in ConfigCat. These include:
...
Using the Dashboard is the quickest way to find your stale feature flags...
...
## Notes to develop the new documentation 

- Overview

- There are three ways to manage your Zombie flags.

  1. The Zombie flags report
  2. In your ConfigCat Dashboard
  3. Via the API 