...
There are three ways to access and manage your Zombie flags in ConfigCat:
...
Using the Dashboard is the quickest way to view your zombie flags. Here's how to access the Zombie flags page:
...
The Zombie flags page will show you all the stale flags in your product in a table format. 
You can filter the flags by:

- **Inactivity**
- **Feature flag scope**
- **Included environments**
- **Ignored flags based on tags**
- **Stale in all/any selected environments**
- **Filter by config or feature flag name**
