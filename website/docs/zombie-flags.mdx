...
1. In the [organization overview page](https://app.configcat.com/organization), select the product.
2. Select **Zombie flags** from the product menu at the top of the page.
...
By default, the Zombie Flags page will filter the zombie flags based on the settings set in the **My Zombie Flags Report** page (more on this soon).

:::tip
If you have the [Code references](https://configcat.com/docs/advanced/code-references/overview/) feature enabled, you can also see where the flags are referenced in your code.
:::

### Using the Zombie Flags Report Email

The Zombie Flags Report scans your ConfigCat dashboard and sends an email highlighting the feature flags that haven't been updated or toggled within a specified time frame.
...
The Zombie Flags API allows you to programmatically access and manage your zombie flags.

You can learn more about the Zombie Flags API in the [ConfigCat API documentation](https://api.configcat.com/docs/index.html#tag/Zombie-(stale)-flags).
