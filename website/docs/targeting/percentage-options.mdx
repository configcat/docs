...
<img src="/docs/assets/targeting/percentage-options/add-percentage-option.png" width="700" alt="Add Percentage Option" decoding="async" loading="lazy"/>
...
<img src="/docs/assets/targeting/percentage-options/change-percentage-attribute.png" width="700" alt="Change Percentage Attribute" decoding="async" loading="lazy"/>
