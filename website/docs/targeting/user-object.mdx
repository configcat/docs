...
The _User Object_ represents a user in your application. It is a collection of _user attributes_ that store various pieces of information about the user.
...
The unique identifier of a user in your application. This is a **REQUIRED** attribute. ConfigCat uses this attribute to differentiate your users from each other. By default, it is used to evaluate [Percentage Options](../percentage-options).
