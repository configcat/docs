...
- [User condition](/V2/targeting/targeting-rule/user-condition) - A condition that is based on some property of the user.
- [Flag condition (Prerequisite)](/V2/targeting/targeting-rule/flag-condition) - A condition that is based on the value of another feature flag.
- [Segment condition](/V2/targeting/targeting-rule/segment-condition) - A condition that is based on a segment.
