...
The segment is evaluated with the [User Object](../../user-object). Then the result is checked against the comparator you set on the Dashboard:
...
For more details on the evaluation of Segment Conditions, please refer to [Feature Flag Evaluation](../../feature-flag-evaluation#evaluation-of-a-segment-condition).
...
<img alt="Target a segment" src="/docs/assets/targeting/targeting-rule/segment-condition/target-segment_192dpi.png" width="700" height="525" decoding="async" loading="lazy" />
...
<img alt="Add segment" src="/docs/assets/targeting/targeting-rule/segment-condition/add-segment_192dpi.png" width="871" height="525" decoding="async" loading="lazy" />

## Anatomy of a Segment Condition

<img alt="Segment condition" src="/docs/assets/targeting/targeting-rule/segment-condition/segment-condition-anatomy_192dpi.png" width="1033" height="46" decoding="async" loading="lazy" />
...
On the Dashboard:
<img alt="Beta testing example" src="/docs/assets/targeting/targeting-rule/segment-condition/beta-testing-example_192dpi.png" width="1084" height="433" decoding="async" loading="lazy" />