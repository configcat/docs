...
:::info
The .NET SDK supports [shared caching](/docs/advanced/caching/#shared-cache) since v8.1.0. As for other SDKs, please check their docs for the minumum versions
