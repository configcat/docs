...
Head to the [Releases](https://github.com/configcat/unreal-engine-sdk/releases) page and download the latest `ConfigCat.zip` archive.
...
Add Dependency to your `.Build.cs` file:
