...
| `matched_evaluation_percentage_rule` | If the evaluation was based on a percentage rule, this property contains that specific rule. |
| `matched_evaluation_rule`            | If the evaluation was based on a Targeting Rule, this property contains that specific rule.  |
