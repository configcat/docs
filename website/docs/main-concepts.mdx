...
#### Feature Flag Values: Plain Values vs Predefined Variations

When creating a feature flag or setting, you can choose how to manage its values:

**Plain Values**: Enter values directly each time you configure a rule or target. Best for simple, one-off configurations or quick experiments.
...
:::tip
Learn more about [Feature Flag Variations](/docs/feature-flag-variations) including when to use each approach, how to convert between types, and best practices.
:::
