...
A _Setting_ is an essential bit of _ConfigCat_. It can be of multiple types, such as an on/off switch (bool), number (int, double) or any text (string) your application requires to be modified without the need for a new deployment.
