...
#### [Alpha Testing](./glossary/alpha-testing.mdx)
...
#### [Beta Testing](./glossary/beta-testing.mdx)
...
#### [Blue/Green Deployment](./glossary/blue-green-deployment.mdx)
...
#### [Continuous Integration](./glossary/continuous-integration.mdx)
...
#### [DevOps Engineer](./glossary/devops-engineer.mdx)
...
#### [Feature Testing](./glossary/feature-testing.mdx)
...
#### [Product Lifecycle Manager](./glossary/product-lifecycle-manager.mdx)
...
#### [Smoke Testing](./glossary/smoke-testing.mdx)
...
#### [Version Control](./glossary/version-control.mdx)
