...
<Tabs>
  <TabItem value="metadataUrl" label="Metadata URL" default>
    <ul>
      <li>
        Copy the value of <code>App Federation Metadata Url</code>.
  ...
  <TabItem value="manual" label="Manual Configuration">
    <ul>
      <li>
        Copy the value of the <code>Login URL</code> and <code>Certificate (Base64)</code> fields and paste them into the Configuration dialog at ConfigCat.
...
- ConfigCat will redirect you to Microsoft's sign in page. Type your credentials, and click `Sign In`.
