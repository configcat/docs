...
<img alt="Launching the import tool" src="/docs/assets/migration-from-ld/launch_192dpi.png" width="1366" height="768" decoding="async" loading="lazy" style={{height: "auto"}} />
