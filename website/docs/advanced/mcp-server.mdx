...
:::info
Replace `CONFIGCAT_API_USER` and `CONFIGCAT_API_PASS` environment variables with your [Public Management API basic auth credentials](https://app.configcat.com/my-account/public-api-credentials).
:::
