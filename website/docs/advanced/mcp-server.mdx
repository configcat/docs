...
- Manage organizations & members
  ...
  - Invite, remove, or update member permissions
  - Handle invitations
  - Organize members into permission groups

- Manage products & configurations
  - Create, update, or delete products
  - Set up product configs, environments, and segments
  - Adjust product preferences

- Manage feature flags and settings
  - Create, update, or delete feature flags
  - Control flag values and settings
  - Tag and organize flags

- Connect tools & automate workflows
  - Create and manage integrations
  - Set up webhooks and signing keys
  - Access SDK keys
  
- Track changes & activity
  - Review audit logs for products or organizations
  - Get reports on stale feature flags
  - Find code references linked to your features



- Membership Management: Complete CRUD coverage of ConfigCat management entities
