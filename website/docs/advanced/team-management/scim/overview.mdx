...
After a successful sync from your Identity Provider, each synchronized group will appear on the [Authentication & Provisioning](https://app.configcat.com/organization/authentication/) page in the **2. Assign ConfigCat permissions to Identity Provider groups** section.
