...
TODO: Point to the SCIM endpoints
...
On on the [Authentication & Provisioning](https://app.configcat.com/organization/authentication/) page, 
...
<img src="/docs/assets/scim/dashboard/token_generate.png" alt="ConfigCat SCIM token generate" decoding="async" loading="lazy"/>

From the opening dialog, copy and save the token, it will be used in the Identity Provider configuration section.

<img src="/docs/assets/scim/dashboard/token.png" alt="ConfigCat SCIM token" decoding="async" loading="lazy"/>
