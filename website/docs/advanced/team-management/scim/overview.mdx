...
The user provisining is synchronizing all Identity Provider Users from your Identity Provider regardless if the Identity Provider User's email domain is a verified email domain in ConfigCat or not.  
