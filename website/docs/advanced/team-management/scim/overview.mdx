...
* There is a technical limitation of 500 Identity Provider groups that can have associated ConfigCat permissions. 

There is also a technical limitation of 10000 Users and 1000 Groups that can be synced from your Identity Provider. 

If you hit any of these technical limitations, feel free to [contact us](https://configcat.com/support) and we'll adjust it to your needs.
