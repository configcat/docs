...
- On the OneLogin application's Configuration tab's API Connection section configure the following:
  ...
  <img className="bordered-img" src="/docs/assets/scim/onelogin/configuration.png" alt="ConfigCat authentication settings" decoding="async" loading="lazy" />
...
- On the OneLogin application's Provisioning tab configure the following:
  ...
  <img className="bordered-img" src="/docs/assets/scim/onelogin/enable_provisioning.png" alt="ConfigCat authentication settings" decoding="async" loading="lazy" />

- On the OneLogin application's Parameters tab configure the following:
  - Set Email as the `scimusername` parameter.
    <img className="bordered-img" src="/docs/assets/scim/onelogin/scimusername.png" alt="SCIM username parameter" decoding="async" loading="lazy" />
  - Check the `Include in User Provisioning` checkbox at the Groups parameter.
    <img className="bordered-img" src="/docs/assets/scim/onelogin/include_in_provisioning.png" alt="Include in User Provisioning" decoding="async" loading="lazy" />
...
- On the OneLogin application's Rules tab configure which property should OneLogin send as the user's groups to ConfigCat.  
  ...
  <img className="bordered-img" src="/docs/assets/scim/onelogin/rule.png" alt="Include in User Provisioning" decoding="async" loading="lazy" />
...
## 3. Assign users manually to the application or set access based on policies/roles on the OneLogin application's Access tab.
  ...
  <img className="bordered-img" src="/docs/assets/scim/onelogin/assign.png" alt="ConfigCat Name Identity Provider" decoding="async" loading="lazy" />

## 4. Start provisioning
- On the OneLogin application's Configuration tab click on the `Enable` button to start the provisioning.
  <img className="bordered-img" src="/docs/assets/scim/onelogin/enable.png" alt="ConfigCat Add Identity Provider" decoding="async" loading="lazy" />
