...
Go to the [Authentication & Provisioning](https://app.configcat.com/organization/authentication/) page to set up 3rd party SSO. You need to be an
...
Read more about [SAML SSO](../../advanced/team-management/saml/overview.mdx).
