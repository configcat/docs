...
- From the appearing dialog, copy the following values and paste them into the OneLogin application's configuration page.
    ...
    <img className="saml-tutorial-img" src="/docs/assets/saml/onelogin/saml_config.png" alt="OneLogin SML configuration" />
  ...
  <TabItem value="metadataUrl" label="Metadata URL" default>
    <ul>
      ...
      <li>
        ...
        <img className="saml-tutorial-img" src="/docs/assets/saml/onelogin/cc_meta_url.png" alt="ConfigCat SAML configuration" />
      </li>
      <li>
  ...
  <TabItem value="manual" label="Manual Configuration">
    <ul>
      ...
      <li>
        ...
        <img className="saml-tutorial-img" src="/docs/assets/saml/onelogin/cc_manual.png" alt="ConfigCat manual configuration" />
      </li>
      <li>
        Click on <code>Save</code>.
      </li>
