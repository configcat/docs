...
- Log in to <a href="https://dash.cloudflare.com/" target="_blank">CloudFlare</a>, go to the Zero Trust Dashboard, and select `Applications` under the `Access` menu.  
  ...
  <img className="bordered-img" src="/docs/assets/saml/cloudflare/add_app.png" alt="Create Cloudflare application" decoding="async" loading="lazy" />

- Select `SaaS`.

  <img className="bordered-img" src="/docs/assets/saml/cloudflare/add_saas.png" alt="Select SaaS" decoding="async" loading="lazy"/>

- Enter a descriptive name in the `Application` field.

  <img className="bordered-img" src="/docs/assets/saml/cloudflare/app_name.png" alt="Cloudflare app name" decoding="async" loading="lazy"/>
...
- Give a name for your Identity Provider, and click `Create`.
  ...
  <img className="bordered-img" src="/docs/assets/saml/dashboard/cf_name.png" alt="ConfigCat Name Identity Provider" decoding="async" loading="lazy" />
...
- From the next section of the dialog, copy the following values and paste them into the Cloudflare application.
  ...
  - `Assertion Consumer Service` -> `Assertion Consumer Service URL`
    ...
    <img className="bordered-img" src="/docs/assets/saml/cloudflare/meta.png" alt="Cloudflare SAML url EID" decoding="async" loading="lazy" />

- Set the `Name ID Format` to `Email`.

  <img className="bordered-img" src="/docs/assets/saml/cloudflare/name_id.png" alt="Cloudflare SAML name id" decoding="async" loading="lazy" />
...
- Give a name for the Cloudflare Application's policy and check those groups that you want to assign.
  ...
  <img className="bordered-img" src="/docs/assets/saml/cloudflare/policy.png" alt="Cloudflare SAML name id" decoding="async" loading="lazy" />
...
- Copy the value of `SSO endpoint` and `Public key` fields.
  ...
  <img className="bordered-img" src="/docs/assets/saml/cloudflare/cert_sign_on_url.png" alt="Cloudflare SSO url cert" decoding="async" loading="lazy" />
...
- On the ConfigCat Dashboard, select the `3. Set up ConfigCat` step, click `Manual Configuration`, then paste the copied values into the appearing fields.
  ...
  - `Public key` -> `X.509 Certificate`
    ...
    <img className="bordered-img" src="/docs/assets/saml/dashboard/cf_manual.png" alt="ConfigCat manual configuration" decoding="async" loading="lazy" />
...
- ConfigCat will redirect you to Cloudflare's sign in page.
  ...
  <img className="bordered-img" src="/docs/assets/saml/cloudflare/login_page.png" alt="Cloudflare sign in" decoding="async" loading="lazy" />
