  ...
  <TabItem value="metadataUrl" label="Metadata URL" default>
    <ul>
      ...
      <li>
        ...
        <img className="saml-tutorial-img" src="/docs/assets/saml/adfs/cc_metadata.png" alt="ADFS metadata url" />
      </li>
      <li>
  ...
  <TabItem value="manual" label="Manual Configuration">
    <ul>
      ...
      <li>
        ...
        <img className="saml-tutorial-img" src="/docs/assets/saml/adfs/cc_manual.png" alt="ConfigCat manual configuration" />
      </li>
      <li>
        Click on <code>Save</code>.
      </li>
