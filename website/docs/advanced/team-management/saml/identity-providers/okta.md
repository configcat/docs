...
- From the appearing dialog, copy the following values and paste them into the Okta application.
    ...
    <img className="saml-tutorial-img" src="/docs/assets/saml/okta/saml_url_eid.png" alt="Okta SAML url EID" />

- Set the `Name ID format` to `EmailAddress`, then click `Next`.

  <img className="saml-tutorial-img" src="/docs/assets/saml/okta/saml_nameid.png" alt="Okta SAML nameid" />
  ...
  <TabItem value="metadataUrl" label="Metadata URL" default>
    <ul>
      ...
      <li>
        ...
        <img className="saml-tutorial-img" src="/docs/assets/saml/okta/cc_metadata.png" alt="ConfigCat metadata url" />
      </li>
      <li>
  ...
  <TabItem value="manual" label="Manual Configuration">
    <ul>
      ...
      <li>
        ...
        <img className="saml-tutorial-img" src="/docs/assets/saml/okta/manual_cc.png" alt="ConfigCat manual configuration"  />
      </li>
      <li>
        Click on <code>Save</code>.
      </li>
