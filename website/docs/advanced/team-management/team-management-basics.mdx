...
<Steps>
<Step>
Click the `Invite Team Members` button on the sidebar.
</Step>
<Step>
Enter the invitees' email addresses (comma separated list).
</Step>
<Step>
Select a _Permission group_ and click on **SEND INVITATION EMAIL**.
</Step>
<Step>
...
Read more about [SSO](single-sign-on-sso.mdx).
