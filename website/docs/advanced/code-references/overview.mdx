...
<img src="/docs/assets/cli/scan.gif" className="zoomable" alt="flag-percentage-add" decoding="async" loading="lazy" />
...
<img className="zoomable" src="/docs/assets/cli/scan/scan_report.png" alt="ConfigCat code references report" decoding="async" loading="lazy" />
