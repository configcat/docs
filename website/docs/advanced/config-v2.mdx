...
- New API: [See the API Docs.](/api/reference/configcat-public-management-api)
...
![AND conditions](/assets/config-v2/and-conditions.png)

### New comparators

With the new comparators, you can create Targeting Rules which are based on dates, based on comparing arrays, and more. 
...
![New comparators](/assets/config-v2/new-comparators.png)
...
![Prerequisite flags](/assets/config-v2/prerequisite-flags.png)
...
![Percentage Options within Targeting Rules](/assets/config-v2/percentage-options-within-targeting-rules.png)
...
![Custom Percentage Attributes](/assets/config-v2/custom-percentage-attributes.png)
