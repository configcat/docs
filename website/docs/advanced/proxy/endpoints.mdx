...
| Android (Java)   | \<=&nbsp;[v9.1.1](https://github.com/configcat/android-sdk/releases/tag/v9.1.1) |
| C++              | \<=&nbsp;[v3.1.1](https://github.com/configcat/cpp-sdk/releases/tag/v3.1.1)     |
| Dart (Flutter)   | \<=&nbsp;[v3.0.0](https://github.com/configcat/dart-sdk/releases/tag/3.0.0)     |
...
| JS - Legacy      | \<=&nbsp;[v8.1.1](https://github.com/configcat/js-sdk/releases/tag/v8.1.1)      |
| JS SSR - Legacy  | \<=&nbsp;[v7.1.1](https://github.com/configcat/js-ssr-sdk/releases/tag/v7.1.1)  |
| Kotlin           | \<=&nbsp;[2.0.0](https://github.com/configcat/kotlin-sdk/releases/tag/2.0.0)    |
| Node - Legacy    | \<=&nbsp;[v10.1.1](https://github.com/configcat/node-sdk/releases/tag/v10.1.1)  |
...
| Swift (iOS)      | \<=&nbsp;[v10.0.0](https://github.com/configcat/swift-sdk/releases/tag/10.0.0)  |
