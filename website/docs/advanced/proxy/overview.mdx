...
const url = "http://localhost:8050/sse/my-sdk/eval"; // Proxy SSE URL with SDK identifier
...
- ### 2. Manual configuration
  ...
  For example, suppose we have the following setup: `CONFIGCAT_SDKS={"my-sdk":"<your-sdk-key>"}`.  
  ...
  #### Additional options for the underlying SDK
