...
These are the possible ways to use the Proxy from your application:

- ### 1. Using a ConfigCat SDK in your application connected to the Proxy
...
- ### 2. Evaluating feature flags with the Proxy's API endpoints
  ...
  You can find all endpoints with each HTTP request/response schema under the [API's documentation section](endpoints.mdx#api).

- ### 3. Evaluating feature flags and listen to changes with SSE
...
- ### 4. Evaluating feature flags and streaming with gRPC
