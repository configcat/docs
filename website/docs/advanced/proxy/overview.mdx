...
- ### 3. Evaluating feature flags with OpenFeature Remote Evaluation (OFREP)
...
- ### 4. Evaluating feature flags and listen to changes with SSE
...
- ### 5. Evaluating feature flags and streaming with gRPC
