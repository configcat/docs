...
- #### Select which SDK Keys your Proxy should use
  ...
  - ##### Selection rules
    ...
    Rules can be based on products, configs and environments with the following filtering options:
      ...
      - **Match expression**: This option matches the given pattern to the names of products/configs/environments, accepting wildcards (`*`). It's sensitive to product, config, and environment renaming.
