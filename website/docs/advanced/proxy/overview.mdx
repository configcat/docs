...
<td><code>false</code></td>
<td>Enables or disables the hosting of the <a href="/docs/advanced/proxy/monitoring/#status">status endpoint</a> on the main HTTP port. (default: <code>8050</code>)</td>
</tr>
