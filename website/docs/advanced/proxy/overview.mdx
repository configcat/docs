...
- **8050**: for standard HTTP communication. ([API](/advanced/proxy/endpoints#api), [CDN proxy](/advanced/proxy/endpoints#cdn-proxy), [Webhook](/advanced/proxy/endpoints#webhook), [SSE](/advanced/proxy/endpoints#sse))
- **8051**: for providing diagnostic data ([status](/advanced/proxy/monitoring#status), [prometheus metrics](/advanced/proxy/monitoring#prometheus-metrics)).
...
<td>-</td>
<td>The <a href="/docs/advanced/notifications-webhooks/#calculating-signature">key used to sign</a> the webhook requests sent to the Proxy. <a href="/docs/v2/advanced/proxy/endpoints#webhook">More about the webhook endpoint</a>.</td>
</tr>
