...
<td>The HTTP server's port that serves the <a href="/docs/V2/advanced/proxy/endpoints#cdn-proxy">CDN proxy</a>, <a href="/docs/V2/advanced/proxy/endpoints#api">API</a>, <a href="/docs/V2/advanced/proxy/endpoints#sse">SSE</a>, and <a href="/docs/V2/advanced/proxy/endpoints#webhook">webhook</a> endpoints.</td>
</tr>
...
<td><code>false</code></td>
<td>Enables or disables the hosting of the <a href="/docs/V2/advanced/proxy/monitoring/#status">status endpoint</a> on the main HTTP port. (default: <code>8050</code>)</td>
</tr>
