...
<Step>
<Title>
### Local evaluation using a ConfigCat SDK connected to the Proxy
</Title>
...
<Step>
<Title>
### Remote evaluation with the Proxy's API endpoints
</Title>
...
<Step>
<Title>
### Remote evaluation with OpenFeature Remote Evaluation Protocol (OFREP)
</Title>
...
<Step>
<Title>
### Remote evaluation and streaming with SSE
</Title>
...
<Step>
<Title>
### Remote evaluation and streaming with gRPC
</Title>
...
- #### Create a new Proxy profile
  ...
  <img alt="Add Profile" src="/docs/assets/proxy/profile-add2.png" width="1366" height="768" decoding="async" loading="lazy" />

  Give the profile a meaningful name and description, then click `CREATE`.
  <img alt="Create Profile" src="/docs/assets/proxy/profile-create2.png" width="1366" height="768" decoding="async" loading="lazy" />
  <br/>
  <br/>
...
- #### Configure your Proxy instance
  ...
  <img alt="Configure Proxy with key and secret" src="/docs/assets/proxy/profile-key-secret2.png" width="1366" height="768" decoding="async" loading="lazy" />
...
- #### Select which SDK Keys your Proxy should use
  ...
  <img alt="Click on Select SDK Keys" src="/docs/assets/proxy/profile-sdk-keys-configure2.png" width="1366" height="768" decoding="async" loading="lazy" />
  ...
  - ##### Manual selection
    ...
    <img alt="Select SDK Keys" src="/docs/assets/proxy/profile-sdk-keys-select2.png" width="1366" height="768" decoding="async" loading="lazy" />
...
- #### (Optional) Set up how your Proxy should learn about feature flag changes
  ...
  - ##### Config JSON poll interval 
    ...
    <img alt="Set config JSON poll interval" src="/docs/assets/proxy/profile-sdk-poll-interval2.png" width="1366" height="768" decoding="async" loading="lazy" />
    <br/>
    <br/>
  ...
  - ##### Webhook notification
    ...
    <img alt="Set Proxy webhook URL" src="/docs/assets/proxy/profile-webhook-url2.png" width="1366" height="768" decoding="async" loading="lazy" />
    ...
    <img alt="Copy webhook signing key" src="/docs/assets/proxy/profile-webhook-signing-key2.png" width="1366" height="768" decoding="async" loading="lazy" />
    ...
    <img alt="Test the webhook configuration" src="/docs/assets/proxy/profile-webhook-test2.png" width="1366" height="768" decoding="async" loading="lazy" />
    <br/>
    <br/>
