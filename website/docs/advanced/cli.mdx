...
Finally, the CLI provides a few useful utilities, such as validating a config JSON file, downloading one from the ConfigCat CDN by SDK Key, etc. These can come in handy when you use [flag overrides](../../sdk-reference/js/overview#flag-overrides) in your application.
...
<img src="/docs/assets/cli/cli-setup.gif" alt="interactive" decoding="async" loading="lazy"/>
...
<img src="/docs/assets/cli/cli-flag-create.gif" alt="interactive" decoding="async" loading="lazy"/>
...
<img src="/docs/assets/cli/cli-flag-update.gif" alt="flag value update" decoding="async" loading="lazy"/>

### Add targeting rules

The following example shows how you can add targeting rules to a feature flag.

<img src="/docs/assets/cli/cli-flag-targeting-add.gif" alt="flag targeting add" decoding="async" loading="lazy"/>

### Add percentage options

The following example shows how you can set percentage options in a feature flag.

<img src="/docs/assets/cli/cli-flag-targeting-percentage.gif" alt="flag percentage add" decoding="async" loading="lazy"/>
