...
Upgrade to Config V2 and unlock a range of exciting new features for your feature flags. With AND conditions, you
can create complex targeting rule sets to precisely control feature rollouts. Prerequisite flags allow your
feature flags to depend on each other, enabling more advanced flag dependencies. Easily navigate complex rule sets
with the new targeting rule notes feature. Plus, enjoy additional comparators for date-based targeting rules,
array comparisons, and more!

Migrate to Config V2 and take your feature flagging to the next level. Check out the [detailed guide](/advanced/config-v2) to know more about Config V2 and the new features.
