...
- **Can bypass approval** - The member can approve any change request opened by other members, or apply changes directly without going through the approval flow.
