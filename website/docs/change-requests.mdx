...
A change request can be scheduled to apply automatically at a selected date and time. You can create a scheduled change request from the down arrow next to the **Save & publish** or **Propose changes** button and selecting **Schedule changes**.
