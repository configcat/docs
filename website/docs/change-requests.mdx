...
- Members with **Can bypass approval** permission can approve change requests or apply changes directly, skipping the approval step.
...
- **Circular dependency**: Changes to the included feature flags were published concurrently after the change request was opened, and applying the change request now would create a circular dependency through prerequisite flags.
