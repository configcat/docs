...
It allows you to pass potential [Targeting Rule](/targeting/targeting-overview) variables to the ConfigCat SDK.
And represents a user in your application.

> The _User Object_ is essential if you'd like to use ConfigCat's [Targeting](/targeting/targeting-overview) feature.

## The relationship between User Object and Targeting Rules

**As a product manager**, you can set [Targeting Rules](/targeting/targeting-overview) on the <a href="https://app.configcat.com" target="_blank">ConfigCat Dashboard</a> based on the parameters given to ConfigCat by your application.

**As a developer**, User Object allows you to pass optional parameters to the ConfigCat SDK, which you (or your teammates) can use in the <a href="https://app.configcat.com" target="_blank">ConfigCat Dashboard</a> to apply [Targeting Rules](/targeting/targeting-overview) on.
