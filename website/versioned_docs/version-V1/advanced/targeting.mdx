...
This value will be served as a fallback if none of the above rules apply or a [`User Object`](/targeting/user-object) is not passed to the [ConfigCat SDK](/sdk-reference/overview) correctly within your application.
...
This value will be served as a fallback if none of the above rules apply or a [`User Object`](/targeting/user-object) was not passed to the [ConfigCat SDK](/sdk-reference/overview) correctly within your application.
