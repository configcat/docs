...
<img src="/docs/assets/targeting-1.png" className="zoomable" alt="targeting-1" decoding="async" loading="lazy" />
...
<img src="/docs/assets/sensitive2.png" className="zoomable" alt="Confidential" decoding="async" loading="lazy" />
...
On the Dashboard:
<img src="/docs/assets/sensitive1.png" className="zoomable" alt="Confidential" decoding="async" loading="lazy" />
...
<img src="/docs/assets/targeting-2.png" className="zoomable" alt="targeting-2" decoding="async" loading="lazy" />
