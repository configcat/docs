...
1. <a href="https://app.configcat.com" target="_blank">Log in</a> to access the _Dashboard_
2. Go to **Feature Flags & Settings**
3. Select **TARGET SPECIFIC USERS** after clicking the actions icon.

<img src="/docs/assets/targeting-1.png" alt="targeting-1" decoding="async" loading="lazy" />
...
<img src="/docs/assets/sensitive2.png" alt="Confidential" decoding="async" loading="lazy" />
...
On the Dashboard:
<img src="/docs/assets/sensitive1.png" alt="Confidential" decoding="async" loading="lazy" />
...
This value will be served as a fallback if none of the above rules apply or a [`User Object`](user-object.mdx) is not passed to the [ConfigCat SDK](../sdk-reference/overview.mdx) correctly within your application.
...
<img src="/docs/assets/targeting-2.png" alt="targeting-2" decoding="async" loading="lazy" />
...
This value will be served as a fallback if none of the above rules apply or a [`User Object`](user-object.mdx) was not passed to the [ConfigCat SDK](../sdk-reference/overview.mdx) correctly within your application.
