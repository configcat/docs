...
In order to use the [SAML Single Sign-On](/docs/advanced/team-management/saml/saml-overview) and the [Auto-assign Users](auto-assign-users.mdx) features, you have to verify the ownership of the domain that your company uses for email addresses.
