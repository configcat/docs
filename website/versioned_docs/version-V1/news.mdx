...
If you're a LaunchDarkly user and curious about switching, we have good news for you: we've launched a new feature
...
From now on you can:
 ...
 <ul>
    <li>
        <a href="https://configcat.com/docs/V1/integrations/mixpanel/#annotations" target="_blank"
            rel="noopener noreferrer">Monitor feature flag change events in Mixpanel with Annotations</a>
    </li>
    <li>
        <a href="https://configcat.com/docs/V1/integrations/mixpanel/#experiments" target="_blank"
            rel="noopener noreferrer">Send feature flag evaluation analytics to Mixpanel Experiments</a>
    </li>
    <li>
        <a href="https://configcat.com/docs/V1/integrations/amplitude/#experiments" target="_blank"
            rel="noopener noreferrer">Send feature flag evaluation analytics to Amplitude Experiments</a>
    </li>
    <li>
        <a href="https://configcat.com/docs/V1/integrations/google-analytics" target="_blank"
...
- [Detailed Docs about comparators](./advanced/targeting.mdx#confidential-text-comparators)
...
- [Detailed Docs about comparators](./advanced/targeting.mdx#comparator)
