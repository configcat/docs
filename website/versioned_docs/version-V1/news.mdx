...
the Proxy has the ability to use [Proxy profiles](https://app.configcat.com/organization/proxy-profiles) to determine which SDK keys to download and distribute.
   ...
   <p>
   [See the documentation](/docs/advanced/proxy/proxy-overview/#1-automatic-configuration-with-proxy-profiles) for more information on how to set up your Proxy with profiles.
   </p>
