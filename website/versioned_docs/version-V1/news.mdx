...
## Integration management in Public Management API and Terraform

#### Aug 13, 2024

From now on, you can manage your Integrations through the ConfigCat Public Management API and the Terraform provider. See the docs for details:
