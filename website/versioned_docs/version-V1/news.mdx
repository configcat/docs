...
We're happy to share that we have introduced new ways to track your featuer flags in your Analytics tools.

 <ul>
    <li>
        <a href="https://configcat.com/docs/V1/integrations/mixpanel/#annotations" target="_blank"
            rel="noopener noreferrer">Monitoring your feature flag change events in Mixpanel with Annotations</a>
    </li>
    <li>
        <a href="https://configcat.com/docs/V1/integrations/mixpanel/#experiments" target="_blank"
            rel="noopener noreferrer">Sending feature flag evaluation analytics to Mixpanel Experiments</a>
    </li>
    <li>
        <a href="https://configcat.com/docs/V1/integrations/amplitude/#experiments" target="_blank"
            rel="noopener noreferrer">Sending feature flag evaluation analytics to Amplitude Experiments</a>
    </li>
    <li>
        <a href="https://configcat.com/docs/V1/integrations/google-analytics" target="_blank"
            rel="noopener noreferrer">Sending feature flag evaluation analytics to Google Analytics</a>
    </li>
</ul>
