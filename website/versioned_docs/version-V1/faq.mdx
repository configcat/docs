...
<img src="/docs/assets/faq/or-example.png" alt="OR example" decoding="async" loading="lazy" />
...
<img src="/docs/assets/faq/and-example.png" alt="AND example" decoding="async" loading="lazy" />
