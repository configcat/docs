...
:::info
This documentation applies to the **v7.x version** of the ConfigCat Ruby SDK. For the documentation of the latest release, please refer to [this page](/sdk-reference/ruby).
:::
