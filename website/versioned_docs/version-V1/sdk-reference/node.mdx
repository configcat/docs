...
:::info
This documentation applies to the **v10.x version** of the ConfigCat Node.js SDK. For the documentation of the latest release, please refer to [this page](/sdk-reference/node).
:::
