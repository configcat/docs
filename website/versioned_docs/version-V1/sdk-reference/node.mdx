...
<p>[ConfigCat Node.js SDK on GitHub](https://github.com/configcat/node-sdk)</p>

:::info
This documentation applies to the **v10.x version** of the ConfigCat Node.js SDK. For the documentation of the latest release, please refer to [this page](../../../docs/sdk-reference/node.mdx).
:::
