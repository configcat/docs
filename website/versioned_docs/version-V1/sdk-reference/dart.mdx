...
:::info
This documentation applies to the **v3.x version** of the ConfigCat Dart (Flutter). For the documentation of the latest release, please refer to [this page](/sdk-reference/dart).
:::
