...
:::info
This documentation applies to the **v2.x version** of the ConfigCat Kotlin Multiplatform SDK. For the documentation of the latest release, please refer to [this page](/sdk-reference/kotlin).
:::
