...
:::info
This documentation applies to the **v8.x version** of the ConfigCat .NET SDK. For the documentation of the latest release, please refer to [this page](/sdk-reference/dotnet).
:::
