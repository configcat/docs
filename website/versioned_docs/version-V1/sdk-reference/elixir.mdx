...
:::info
This documentation applies to the **v3.x version** of the ConfigCat Elixir SDK. For the documentation of the latest release, please refer to [this page](/sdk-reference/elixir).
:::
...
| `user`          | Optional, _ConfigCat.User Object_. Essential when using Targeting. [Read more about Targeting.](/targeting/targeting-overview)                                         |
