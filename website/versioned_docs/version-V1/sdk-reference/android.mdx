...
:::info
This documentation applies to the **v9.x version** of the ConfigCat Android (Java) SDK. For the documentation of the latest release, please refer to [this page](/sdk-reference/android).
:::
