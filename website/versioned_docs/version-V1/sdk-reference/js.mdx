...
<p>[ConfigCat JavaScript SDK on GitHub](https://github.com/configcat/js-sdk)</p>

:::info
This documentation applies to the **v8.x version** of the ConfigCat JavaScript SDK. For the documentation of the latest release, please refer to [this page](../../../docs/sdk-reference/js.mdx).
:::
