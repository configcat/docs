...
| Info  | Errors, warnings and feature flag evaluation are logged. |
| Debug | All of the above plus debug info is logged.             |

### Specifying a User Object

The [User Object](../../advanced/user-object.mdx) stores attributes of a user in your application. It works hand in hand with ConfigCat's [Targeting](../../advanced/targeting.mdx) rules for targeting specific users with feature flags. A User Object can be passed as a prop to the `FeatureWrapper` component.

> See documentation [here](../../advanced/user-object.mdx).
