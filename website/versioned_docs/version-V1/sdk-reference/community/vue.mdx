...
The [User Object](../../advanced/user-object.mdx) stores attributes of a user in your application. It works hand in hand with ConfigCat's [Targeting](/targeting/targeting-overview) rules for targeting specific users with feature flags. A User Object can be passed as a prop to the `FeatureWrapper` component.
