...
<img src="/docs/assets/jira/v1/auth.gif" className="bordered-img" alt="Installation of the ConfigCat Feature Flags Jira Cloud Plugin" decoding="async" loading="lazy" />
...
<img src="/docs/assets/jira/v1/link-existing.gif" className="bordered-img" alt="Linking existing feature flags in Jira Cloud Plugin" decoding="async" loading="lazy" />
...
<img src="/docs/assets/jira/v1/create-link.gif" className="bordered-img" alt="Create feature flags in Jira Cloud Plugin" decoding="async" loading="lazy" />
...
<img src="/docs/assets/jira/v1/edit-ff.gif" className="bordered-img" alt="View and Edit linked feature flags in Jira Cloud Plugin" decoding="async" loading="lazy" />
...
<img src="/docs/assets/jira/v1/remove-ff.gif" className="bordered-img" alt="Remove linked feature flags in Jira Cloud Plugin" decoding="async" loading="lazy" />
...
<img src="/docs/assets/jira/v1/release-field.gif" className="bordered-img" alt="View feature flags in releases field" decoding="async" loading="lazy" />
...
<img src="/docs/assets/jira/v1/release-hub.gif" className="bordered-img" alt="View feature flags in Release hub" decoding="async" loading="lazy" />
...
<img src="/docs/assets/jira/v1/open-from-dashboard.gif" className="bordered-img" alt="Link in Dashboard" decoding="async" loading="lazy" />
