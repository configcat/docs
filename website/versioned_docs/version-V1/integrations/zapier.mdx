...
<img src="/docs/assets/zapier_signin.png" className="zoomable" alt="zapier_signin" decoding="async" loading="lazy"/>
...
<img src="/docs/assets/zapier_auth.png" className="zoomable" alt="zapier_auth" decoding="async" loading="lazy"/>
...
<img src="/docs/assets/zapier_customize.png" className="bordered-img zoomable" alt="zapier_customize" decoding="async" loading="lazy"/>
...
<img src="/docs/assets/zapier_config.png" className="bordered-img zoomable" alt="zapier_config" decoding="async" loading="lazy"/>

### Result in Slack

<img src="/docs/assets/zapier_slack.png" className="bordered-img zoomable" alt="zapier_slack" decoding="async" loading="lazy"/>
