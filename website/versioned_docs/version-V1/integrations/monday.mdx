...
<img src="/docs/assets/monday/v1/monday_auth.gif" className="bordered-img" alt="Installation of the ConfigCat Feature Flags monday app" decoding="async" loading="lazy"/>
...
<img src="/docs/assets/monday/v1/monday_link.gif" className="bordered-img" alt="Linking feature flags with the ConfigCat Feature Flags monday.com app" decoding="async" loading="lazy"/>
...
<img src="/docs/assets/monday/v1/monday_create.gif" className="bordered-img" alt="Create feature flags with the ConfigCat Feature Flags monday app" decoding="async" loading="lazy"/>
