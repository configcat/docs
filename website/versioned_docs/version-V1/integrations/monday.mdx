...
<img src="/docs/assets/monday/v1/monday_auth.gif" className="bordered-img zoomable" alt="Installation of the ConfigCat Feature Flags monday app" />
...
<img src="/docs/assets/monday/v1/monday_link.gif" className="bordered-img zoomable" alt="Linking feature flags with the ConfigCat Feature Flags monday.com app" />
...
<img src="/docs/assets/monday/v1/monday_create.gif" className="bordered-img zoomable" alt="Create feature flags with the ConfigCat Feature Flags monday app" />
