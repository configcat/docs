...
<img src="/docs/assets/monday/v1/monday_auth.gif" className="zoomable" alt="Installation of the ConfigCat Feature Flags monday app" />
...
<img src="/docs/assets/monday/v1/monday_link.gif" className="zoomable" alt="Linking feature flags with the ConfigCat Feature Flags monday.com app" />
...
<img src="/docs/assets/monday/v1/monday_create.gif" className="zoomable" alt="Create feature flags with the ConfigCat Feature Flags monday app" />
