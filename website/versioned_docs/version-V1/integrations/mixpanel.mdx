...
<img src="/docs/assets/mixpanel/annotation.png" className="zoomable" alt="Mixpanel Annotation" decoding="async" loading="lazy" />

### Installation

1. Have a [Mixpanel account](https://mixpanel.com/).
2. Create a Service account that has at least an Analyst role. <img src="/docs/assets/mixpanel/service_account.png" className="zoomable" alt="mixpanel_service_Account" decoding="async" loading="lazy" />
...
<img src="/docs/assets/mixpanel/experiments.png" className="zoomable" alt="Mixpanel Experiments report" decoding="async" loading="lazy" />
...
<img src="/docs/assets/mixpanel/insights.png" className="zoomable" alt="Mixpanel Insights report" decoding="async" loading="lazy" />
...
<img src="/docs/assets/mixpanel/enrichment.png" className="zoomable" alt="Mixpanel Insights report with enriched data" decoding="async" loading="lazy" />