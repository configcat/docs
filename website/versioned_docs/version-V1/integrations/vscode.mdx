...
<img src="/docs/assets/vscode/v1/usage.gif" className="zoomable" alt="Usage of ConfigCat Feature Flags Visual Studio Code Extension" decoding="async" loading="lazy"/>
...
<img src="/docs/assets/vscode/v1/auth.gif" className="zoomable" alt="Installation of ConfigCat Feature Flags Visual Studio Code Extension" decoding="async" loading="lazy"/>
